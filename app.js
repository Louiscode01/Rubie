...
const SECTION_TO_KEY = Object.fromEntries(Object.entries(KEY_TO_SECTION).map(([k, v]) => [v, k]));
...
function Compass({
  ...
  }, lang === "zh" ? "北" : "N"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      left: "50%",
      bottom: -4,
  ...
  }, lang === "zh" ? "南" : "S"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 12,
      borderRadius: "50%",
      border: `0.5px dashed ${ring}`,
      opacity: .4
    }
  }), BUILDING_KEYS.map(k => {
    const p = pts[k];
...
function HoverLabel({
  ...
  }, b.hint[lang === "zh" ? "en" : "zh"], " \xB7 ", b.hint[lang]), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 28,
      fontWeight: 400,
      lineHeight: 1
    }
  }, b.name[lang]), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8,
      height: 1,
      width: 24,
...
function HomeIntro({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      textTransform: "uppercase",
      opacity: .55,
      marginBottom: tiny ? 10 : 14
    }
  }, lang === "zh" ? "个人作品集 · MMXXVI" : "Personal Portfolio · MMXXVI"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "'Cormorant Garamond', 'Noto Serif SC', serif",
  ...
  }, meta.name[lang]), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 6,
      fontFamily: "'Inter', 'Noto Sans SC', sans-serif",
      fontSize: 12,
  ...
  }, meta.role[lang]), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, meta.tagline[lang]), !tiny && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 22,
      fontSize: 10,
      letterSpacing: ".25em",
  ...
  }, lang === "zh" ? "拖动旋转 · 滚轮缩放 · 点击建筑" : "drag to rotate · scroll to zoom · click a building"));
}
...
function TopRightBar({
  ...
  }, "\u4E2D"), /*#__PURE__*/React.createElement("span", {
    style: {
      opacity: .35
    }
  }, "/"), /*#__PURE__*/React.createElement("button", {
...
function SectionPanel({
  ...
  const isDark = palette === "dusk";
  const isResearch = palette === "research";
  const bg = isResearch ? "rgba(245,246,244,.95)" : isDark ? "rgba(28,18,14,.92)" : "rgba(250,247,240,.95)";
  ...
  useEffect(() => {
    ...
    const onKey = e => {
      ...
      const els = Array.prototype.slice.call(panel.querySelectorAll(sel)).filter(el => el.offsetParent !== null);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      pointerEvents: "auto",
      cursor: "pointer",
      background: isDark ? "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.18) 100%)" : "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.04) 100%)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("span", null, b.name[lang]), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: 9,
        letterSpacing: ".25em",
        textTransform: "uppercase",
    ...
    style: {
      ...
      color: fg,
      cursor: "pointer",
      padding: tiny ? "6px 10px" : "8px 14px",
      borderRadius: 999,
      fontFamily: "'Inter', sans-serif",
      fontSize: tiny ? 10 : 11,
      letterSpacing: ".15em",
  ...
  }, "\u2190 ", tiny ? lang === "zh" ? "返回" : "back" : lang === "zh" ? "返回园林" : "back to garden")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      overflowY: "auto",
  ...
  }, section === "about" && /*#__PURE__*/React.createElement(AboutContent, {
    lang: lang,
    muted: muted,
    accent: accent,
    border: border,
    compact: compact,
    tiny: tiny
  }), section === "projects" && /*#__PURE__*/React.createElement(ProjectsContent, {
    lang: lang,
    muted: muted,
    accent: accent,
    border: border,
    compact: compact,
    tiny: tiny
  }), section === "publications" && /*#__PURE__*/React.createElement(PublicationsContent, {
    lang: lang,
    muted: muted,
    accent: accent,
    border: border,
    compact: compact,
    tiny: tiny
  }), section === "contact" && /*#__PURE__*/React.createElement(ContactContent, {
    lang: lang,
    muted: muted,
    accent: accent,
    border: border,
...
function AboutContent({
  ...
  }, a.bio[lang].map((para, i) => /*#__PURE__*/React.createElement("p", {
    key: i,
    style: {
      margin: "0 0 1.1em 0"
    }
  ...
  }, lang === "zh" ? "档案" : "Facts"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 16
    }
  }, a.affiliations[lang].map(([k, v], i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      paddingBottom: 14,
      borderBottom: `0.5px solid ${border}`
...
function ProjectsContent({
  ...
  }, p.intro[lang]), /*#__PURE__*/React.createElement("div", {
  ...
  }, it.kind[lang]), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "'Inter', sans-serif",
      fontSize: 11,
      color: muted,
  ...
  }, it.title[lang]), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "'Cormorant Garamond', 'Noto Serif SC', serif",
      fontSize: 15,
      lineHeight: 1.55,
...
function PublicationsContent({
  ...
  }, it.venue[lang])), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "'Cormorant Garamond', 'Noto Serif SC', serif",
      fontSize: 22,
      lineHeight: 1.25,
  ...
  }, it.authors), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 6,
      paddingLeft: 14,
...
function ContactContent({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      lineHeight: 1.55,
      maxWidth: 640,
      margin: tiny ? "0 0 28px 0" : "0 0 48px 0",
      textWrap: "pretty"
    }
  }, co.invitation[lang]), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: tiny ? "1fr" : `repeat(auto-fill, minmax(${compact ? 240 : 280}px, 1fr))`,
      gap: tiny ? 20 : 28
    ...
    }, ch.label[lang]), /*#__PURE__*/React.createElement("div", {
      style: {
        fontFamily: "'Cormorant Garamond', 'Noto Serif SC', serif",
        fontSize: 19,
        lineHeight: 1.3,
...
function PaletteSwitcher({
  ...
  const isResearch = palette === "research";
  const fg = isResearch ? "#26303a" : isDark ? "#f5e8d8" : "#29261b";
  const bg = isResearch ? "rgba(245,246,244,.82)" : isDark ? "rgba(36,20,16,.6)" : "rgba(250,247,240,.82)";
  const ring = isResearch ? "rgba(74,111,208,.5)" : isDark ? "rgba(255,186,106,.45)" : "rgba(41,38,27,.3)";
  const accent = isResearch ? "#4a6fd0" : isDark ? "#ffba6a" : "#a53a2c";
  const swatches = /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 7
    }
    ...
    }, p.swatch.map((s, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        flex: 1,
        background: s
  ...
  }, lang === "zh" ? "视觉方向" : "Visual direction"), swatches);
}
...
function App() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    compact: compact,
    tiny: tiny
  }), /*#__PURE__*/React.createElement(BuildingNav, {
    lang: lang,
    palette: palette,
    openSection: openSection,
    hovered: hovered,
    ...
    compact: compact,
    tiny: tiny
  }), /*#__PURE__*/React.createElement(PaletteSwitcher, {
    palette: palette,
    setPalette: p => setTweak("palette", p),
    lang: lang,
    compact: compact,
    tiny: tiny
  })), /*#__PURE__*/React.createElement(TopRightBar, {
    lang: lang,
    setLang: l => setTweak("language", l),
    palette: palette
  }), showLabels && section === null && !compact && /*#__PURE__*/React.createElement(HoverLabel, {
    scene: scene,
    hovered: hovered,
    lang: lang,
    palette: palette
  }), showCompass && /*#__PURE__*/React.createElement(Compass, {
    scene: scene,
    palette: palette,
    lang: lang,
    hovered: hovered,
    ...
    compact: compact,
    tiny: tiny
  }), section && /*#__PURE__*/React.createElement(SectionPanel, {
    section: section,
    lang: lang,
    palette: palette,
    close: closeSection,
